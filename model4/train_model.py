...
def train(save_path: str, total_timesteps: int = 1e6, load_model_path: str = None):
    ...
    call_back = EvalCallback(eval_env, best_model_save_path='results_and_models/best_models/model1/',
...
if __name__ == "__main__":
    train(save_path = "results_and_models/final_models/final_model2.zip", load_model_path="results_and_models/final_models/final_model1.zip", total_timesteps=2e6)