...
def test(
    ...
    env = VecFrameStack(env, n_frame_stack)
    ...
    for episode in range(n_episodes):
        ...
        # 打印单轮结果
        print(f"第{episode+1:2d}轮 |奖励：{total_reward:.2f} |得分：{info[0]['score']:4d} | 步数：{step:4d} | "
...
if __name__ == "__main__":
    # 测试20轮（可调整n_episodes）
    test("best_models/model2/best_model.zip", n_episodes=20)