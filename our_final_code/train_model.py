...
def train(save_path :str = None, total_timesteps: int = 5_000_000):
    ...
    eval_call_back = EvalCallback(eval_env, best_model_save_path='results_and_models/best_model2/',
    ...
    model.learn(total_timesteps=total_timesteps, callback=call_backs)
...
if __name__ == "__main__":
    train("results_and_models/final_models/final_model2.zip", total_timesteps=5_000_000)